         ...
         <div className="px-5 md:px-24 text-black flex flex-col gap-10">
            ...
            <div className="bg-[#8bc1c3] rounded-3xl px-3 py-20  md:py-64 flex justify-center items-center scale-110 mt-7 relative topPage border ">
               <div className="absolute transform md:left-0 w-[18rem] md:w-[50rem] justify-between items-center hidden  lg:block chair">
                  <img
                     src="https://res.cloudinary.com/dplikeeby/image/upload/v1749692398/chair_ymbm81.png"
                     alt=""
               ...
               <div className="absolute transform -right-12 md:-right-32 md:top-16 w-[18rem] md:w-[50rem] justify-between items-center  phone">
                  <img
                     src="https://res.cloudinary.com/dplikeeby/image/upload/v1749520517/airpod_mlsywr.png"
                     alt=""
               ...
               <div className="flex flex-col items-start gap-3 z-20 heading ">
                  ...
                  <h1 className="font-black font-poppins uppercase md:tracking-widest text-5xl md:text-[9rem] text-slate-100 ">
                     Collection
                  </h1>
                  <Link to={"/katalog"}>
                     <button className="bg-red-500 rounded-full py-2 px-12 text-white paragraph">
                        Belanja
                     </button>
                  </Link>
               </div>
            ...
            <div className="flex justify-center items-center gap-5 md:gap-16 flex-wrap text-white ">
               {/* 1 */}
               <div
                  className={`bg-merah rounded-3xl w-40 h-52 px-3 py-3 md:w-72 md:h-80 flex justify-st items-end relative overflow-hidden`}
               >
                  <img src={kursiMerah} alt="" className="absolute" />
                  <div className="mb-11">
                     <h1 className="text-2xl font-bold opacity-70 md:tracking-[0.8rem]">
                        Furnitures
                     </h1>
                  </div>
               </div>
               ...
               {/* 2 */}
               <div
                  className={`bg-yellow-400 rounded-3xl w-40 h-52 md:w-72 md:h-80 flex justify-st items-end relative overflow-hidden`}
               >
                  <img
                     src="https://img.freepik.com/free-photo/smartphone-device-with-minimalist-monochrome-background_23-2150763310.jpg?t=st=1737364745~exp=1737368345~hmac=eaf764cd18eb65b06f664611fb424e4dbffa5b805086dffc1aa0e467d043c2b0&w=1380"
                     alt=""
                     className="absolute object-cover w-full h-full"
                  />
                  <div className="mb-11  px-3 py-3">
                     <h1 className="text-2xl font-bold opacity-70 md:tracking-[0.8rem] text-wrap">
                        Phone
                     </h1>
                  </div>
               </div>
               ...
               {/* 4 */}
               <div
                  className={`bg-dark rounded-3xl w-40 h-52 px-3 py-3 md:w-72 md:h-80 flex justify-st items-end relative overflow-hidden`}
               >
            ...
            <div className=" box bg-merah flex flex-col md:flex-row  items-center md:h-[30rem]  gap-5 md:items-center md:gap-72 text-white px-5 md:px-64 pt-16 pb-14  my-20 rounded-3xl relative">
               <img
                  ...
                  alt=""
                  className="absolute right-1/2 transform translate-x-1/2 -top-36 md:-top-72"
               />
               <div className="text-center md:text-start ">
                  <h1 className="heading text-5xl md:text-9xl font-anton font-bold">
                     PROMO PUNCAK
                  </h1>
               ...
               <div className="flex flex-col items-center gap-3">
                  <p>Beats Solo Air</p>
                  <h2 className="text-3xl md:text-6xl font-anton">
                     Summer Sale
                  </h2>
                  <p className="text-sm">
                     Segera ambil promo dalam waktu terdekat
                  </p>
                  <button className="bg-white text-merah px-7 py-2 rounded-full">
                     Belanja
                  </button>
               </div>
            </div>
                  ...
                  >
                     ...
                     <div className="flex justify-between py-2 relative">
                        ...
                        {hoveredProductId === value.id && (
                           <p
                              className="text-white px-5 py-2 bg-merah rounded-full absolute right-1 bottom-1 "
